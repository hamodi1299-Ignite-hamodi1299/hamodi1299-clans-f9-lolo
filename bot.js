...
client.on('message',async message => {
  ...
  message.channel.send(embed);
    ...
    if(args && args[1] === '5eyryeydfhjfgjgjyr4w57n6w54n67547n5476n547n57n56n7w457n45yn5yn5ty5yertyt67yhfghgfhhththt6mu6u65neu6u6uy6uhbe65o4n5n67546yb54yb546n65nomertertretrtretertretretretbretbertrtrt54654n656n546yn6y64njy6567en5476n74') {
      if(system[author.id].clan === 'None') return message.channel.send("**# يجب ان تكون بكلان لأستخدام هذا الأمر**");
      if(clans[system[author.id].clan].creator !== message.author.id) return message.channel.send("**# يجب أن تكون صاحب الكلان لأستخدام هذا الأمر**");
